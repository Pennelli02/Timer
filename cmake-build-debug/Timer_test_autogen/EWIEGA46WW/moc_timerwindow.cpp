...
static constexpr auto qt_meta_stringdata_ZN11TimerWindowE = QtMocHelpers::stringData(
    "TimerWindow",
    "addTimer",
    "",
    "removeTimer",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11TimerWindowE[] = {
...
Q_CONSTINIT const QMetaObject TimerWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11TimerWindowE.offsetsAndSizes,
    qt_meta_data_ZN11TimerWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11TimerWindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TimerWindow, std::true_type>,
        // method 'addTimer'
...
void TimerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->removeTimer((*reinterpret_cast< std::add_pointer_t<TimerItem*>>(_a[1]))); break;
        case 2: _t->selectSound(); break;
        case 3: _t->showTitleEditor(); break;
        default: ;
        }
    }
...
void *TimerWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11TimerWindowE.stringdata0))
